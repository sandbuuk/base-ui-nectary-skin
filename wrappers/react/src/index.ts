...
import '@nectary/components/node_modules'
...
export type Node_modulesProps = JSX.IntrinsicElements['sinch-node_modules'] & WithSlots<NamedSlots['sinch-node_modules']>
export const Node_modules = createReactWrapper<Node_modulesProps, NamedSlots['sinch-node_modules']>('sinch-node_modules')

export type PaginationProps = JSX.IntrinsicElements['sinch-pagination'] & WithSlots<NamedSlots['sinch-pagination']>
export const Pagination = createReactWrapper<PaginationProps, NamedSlots['sinch-pagination']>('sinch-pagination')
