...
export interface UnnamedSlots {
  ...
  'sinch-badge': 1,
  'sinch-button': never,
  'sinch-button-group': 1,
  'sinch-button-group-item': never,
  'sinch-card': never,
  'sinch-card-container': 1,
  'sinch-card-v2': never,
  'sinch-card-v2-title': never,
  ...
  'sinch-persistent-overlay': never,
  'sinch-pop': never,
  'sinch-popover': never,
...
export interface NamedSlots {
  ...
  'sinch-button-group': never,
  'sinch-button-group-item': 'left-icon' | 'icon' | 'right-icon',
  'sinch-card': 'illustration' | 'icon' | 'action',
  'sinch-card-container': never,
  'sinch-card-v2': 'media' | 'title' | 'content' | 'footer',
  'sinch-card-v2-title': 'icon',
  'sinch-checkbox': never,
  ...
  'sinch-pagination': never,
  'sinch-persistent-overlay': 'icon' | 'content' | 'buttons',
  ...
  'sinch-select-menu-option': 'icon' | 'content',
