...
import type { TSinchFileInputElement, TSinchFileInputReact } from './types'

const template = document.createElement('template')

template.innerHTML = templateHTML

defineCustomElement('sinch-file-input', class extends NectaryElement {
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'sinch-file-input': TSinchFileInputReact,
    }
  }

  interface HTMLElementTagNameMap {
    'sinch-file-input': TSinchFileInputElement,
  }
}
