...
export declare const CardTitle: import('react').ForwardRefExoticComponent<CardTitleProps & import('react').RefAttributes<HTMLDivElement>>;
export interface CardContainerProps extends React.HTMLAttributes<HTMLDivElement> {
    /** Content to display inside the container */
    children?: React.ReactNode;
}
export declare const CardContainer: import('react').ForwardRefExoticComponent<CardContainerProps & import('react').RefAttributes<HTMLDivElement>>;
export {};
