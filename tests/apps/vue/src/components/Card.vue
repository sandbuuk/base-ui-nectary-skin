<template>
  <sinch-card
    ...
    :label="label"
    :disabled="isDisabled">
    <sinch-icon-chatbot v-if="hasIcon" slot="icon"></sinch-icon-chatbot>
...
export default {
  ...
  computed: {
    ...
    hasIllustration() {
      return this.search.get('illustration') !== null
    },
    buttonText() {
      return this.search.get('button')
    },
    linkText() {
