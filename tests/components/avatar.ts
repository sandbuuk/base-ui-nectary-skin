...
import type { TSinchAvatarColor } from '@nectary/components/avatar/colors'
...
const colorValues = ['', 'light-pink', 'light-orange', 'light-yellow', 'light-green', 'light-blue', 'light-violet', 'light-gray']
...
test('avatar screenshots', runScreenshotTests('sinch-avatar', [
  ...
  },
  {
    ...
    async *fn({ $eval }) {
      ...
      /* Property */
      const attrValue = await $eval((el, val: TSinchAvatarColor) => {
        el.color = val
