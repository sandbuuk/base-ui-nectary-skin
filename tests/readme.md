...
1) Install and start Docker (accessable in Self Service), alternatively you can use colima as a free open source alternative, following the [installation guide](https://github.com/abiosoft/colima?tab=readme-ov-file#installation) and run `colima start`.
