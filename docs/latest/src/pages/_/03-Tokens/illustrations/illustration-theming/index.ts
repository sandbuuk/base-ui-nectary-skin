...
defineCustomElement('illustration-theming', createIllustrationClass(templateHTML))

declare global {
  namespace JSX {
    interface IntrinsicElements {
      'illustration-theming': TSinchIllustrationReact,
    }

    interface HTMLElementTagNameMap {
      'illustration-theming': TSinchIllustrationElement,
    }
  }
}
